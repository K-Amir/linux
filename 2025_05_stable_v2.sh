...
# REALITY keepalive optimization
net.ipv4.tcp_keepalive_time = 30
net.ipv4.tcp_keepalive_intvl = 5
net.ipv4.tcp_keepalive_probes = 3

# Enhanced connection tracking for REALITY
...
# Memory optimization for high-speed connections
vm.swappiness = 10
...
# TCP memory limits - adjusted for high speed
...
# Optimize interrupt coalescence for REALITY
ethtool -C ${DEFAULT_NIC} adaptive-rx on adaptive-tx on rx-usecs 25 tx-usecs 25 2>/dev/null || true
